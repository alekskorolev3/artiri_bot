module.exports = {
    ...
    humanOrderResponse: {
        'text': 'Привет, меня зовут Ирина. Сейчас я тебе отвечу по поводу заказа работы, а пока можешь написать отзыв о моем новом боте!)'
    },

    humanPriceResponse: {
        'text': 'Привет, меня зовут Ирина. Сейчас я тебе отвечу по поводу цены на работу, а пока можешь написать отзыв о моем новом боте!)'
    },

    humanOtherResponse: {
        'text': 'Привет, меня зовут Ирина. Сейчас я тебе отвечу по поводу данного вопроса, а пока можешь написать отзыв о моем новом боте!)'
    },
