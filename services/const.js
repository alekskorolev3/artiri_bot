...
export const typesOfColoursResponse = {
...
export const clothesListResponse = {
...
export const placeToBuyResponse = {
...
export const howToDeliverResponse = {
    'text': '- почтой\n' +
...
export const deliveringAndPaymentResponse = {
    'text': '📨Доставка:\n' +
        '- белпочтой(+6р)\n' +
        '- европочтой(+4р)\n' +
        '- при личной встрече( Витебск, Барановичи, Минск)\n' +
...
export const humanAgentResponse = {
